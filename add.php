...
<h1 class="w3-xlarge">Add to Database</h1>
<h1>Add videogames to the database by filling the form!</h1>
</header>
<div class="w3-btn-bar ">
<form method="post" action="./results.php">
<h3>Title: </h3><input type="text" name="title" />
<br>
<h3>Review: </h3> <textarea placeholder="Type review here..." name="review" id="review1" style="width: 550px; height:300px;" > </textarea>
<br>
<h3>Link: </h3> <input type="text" name="link" />
<br>
<input type="submit" value= "Add" name="passedData" class="w3-btn w3-border w3-xlarge w3-opacity w3-panel"/>
</form>
