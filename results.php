...
<h1 class="w3-xlarge">Add to Database Results</h1>
</header>
...
$title_name = mysqli_real_escape_string($link, $_POST['title']);
$review_name = mysqli_real_escape_string($link, $_POST['review']);
$link_name = mysqli_real_escape_string($link, $_POST['link']);


$sql = "INSERT INTO videogames (id, title, review, link) VALUES (NULL, '$title_name', '$review_name', '$link_name')";
if(mysqli_query($link, $sql)){
    echo "<h3 class=\"color:green;\"> Records added successfully. </h3>";
} else{
